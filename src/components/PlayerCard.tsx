...
export default function PlayerCard({ player, selected, onClick, showElo = true, streak = 0, rankPosition }: PlayerCardProps) {
  return (
    <div
      onClick={onClick}
    ...
    >
      <StreakFrame streak={streak} size={44} rankPosition={rankPosition} showBadge={streak >= 1}>
