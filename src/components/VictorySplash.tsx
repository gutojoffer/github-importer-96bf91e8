      ...
      <div className="relative z-10 text-center anim-victory-card">
        ...
        <div className="mb-4 anim-crown-drop">
          <svg viewBox="0 0 48 32" className="h-10 w-14 mx-auto" fill="none">
            <path
              d="M4 28L8 10L16 18L24 4L32 18L40 10L44 28H4Z"
            ...
            />
            <circle cx="8" cy="8" r="2.5" fill="hsl(var(--secondary))" />
            <circle cx="24" cy="2" r="2.5" fill="hsl(var(--secondary))" />
            <circle cx="40" cy="8" r="2.5" fill="hsl(var(--secondary))" />
          </svg>
        </div>

        {/* Avatar with glow ring */}
        <div className="relative inline-block mb-4">
          <div className="absolute -inset-2 rounded-full bg-secondary/20 anim-glow-pulse" />
          <Avatar className="h-28 w-28 sm:h-36 sm:w-36 border-[3px] border-secondary relative z-10">
        ...
        {/* Name */}
        <p className="font-heading text-4xl sm:text-5xl font-bold text-secondary tracking-widest italic anim-text-glow">
          {displayName}
        </p>
